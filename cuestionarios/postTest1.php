...
<head>
    ...
    $(function save() {
        ...
        $("#questionsForm").submit(function (event) {
            ...
            fetch('sendPostTest1.php',{method: 'POST', body:datos})
        });
...
<body>
    <div class="container">
        <section title="title">
            <h1 id="titleTest">Cuestionario Post - Modulo 1</h1>
        </section>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content" id="content-modal">
                  ...
                  <div class="modal-footer">
                        <button type="button" id="button-forward" class="btn btn-outline-success"><a href="../tesoro2/actividad1.html">Cerrar para continuar</a></button> 
                  </div>
                </div>
              </div>
            </div>
