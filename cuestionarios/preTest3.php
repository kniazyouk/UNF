...
<head>
    ...
    $(function save() {
        ...
        $("#questionsForm").submit(function (event) {
            ...
            fetch('sendPreTest3.php',{method: 'POST', body:datos})
        });
...
<body>
    <div class="container">
        <section title="title">
            <h1 id="titleTest">Cuestionario Pre - Modulo 3</h1>
        </section>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content" id="content-modal">
                  ...
                  <div class="modal-footer">
                        <button type="button" id="button-forward" class="btn btn-outline-success"><a href="../tesoro3/actividad2.html">Cerrar para continuar</a></button> 
                  </div>
                </div>
              </div>
            </div>
