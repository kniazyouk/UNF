...
<head>
    ...
    $(function save() {
        ...
        $("#questionsForm").submit(function (event) {
            ...
            fetch('sendPreTest2.php',{method: 'POST', body:datos})
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content" id="content-modal">
                  ...
                  <div class="modal-footer">
                        <button type="button" id="button-forward" class="btn btn-outline-success"><a href="../tesoro2/actividad2.html">Cerrar para continuar</a></button> 
                  </div>
                </div>
              </div>
            </div>
